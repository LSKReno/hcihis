<template>
    <div>
        <div style="margin-top: 10px; width: 90%; height: 20px; background-color: #ECF0F5;">
            ...
            <el-button type="text" style="padding-top: 0px; padding-bottom: 0px" @click="confirmAddedItem">开立项目</el-button>
            <i class="el-icon-delete" style="margin-left: 80px; color: #575A8F;"> </i>
            <el-button type="text" style="padding-top: 0px; padding-bottom: 0px" @click="deleteAddedItem">作废项目</el-button>
        ...
        <div>
            <div style="margin-top: 10px; font-size: 12px"><p>合计金额: {{totalCost}} {{message}}</p></div>
        ...
        <div style="width: 90%; height: 100px;margin-left: 11px;
        border-style: solid; border-color: #575A8F; border-radius: 5px;">
            <div style="margin-left: 10px">
                ...
                <div style="float: right; margin-right: 40px;  font-size: 15px"> <i class="el-icon-document" style="color: #575A8F;"> </i> <el-button type="text" @click="handleAddedModel"> 存为模板</el-button></div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        haveAdded(item) {
          for (let i = 0; i < this.addedItems.length; i++) {
              if (this.addedItems[i].itemID == item.itemID)
                  return true
          }
          return false
        },
            ...
            if (this.selectedAddedItems) {
                for (let i = 0; i < this.selectedAddedItems.length; i++) {
                    ...
                    for (let j = 0; j < this.addedItems.length && !hfound; j++) {
                        if (this.selectedAddedItems[i].itemID === this.addedItems[j].itemID) {
                            hfound = 1
    ...
    computed: {
        ...
        filteredItemData () {
            ...
            if (search === '已选择')
                return this.selectedTableItems
