<template>
    <div>
        <div style="height: 40px; margin-left: 10px">
            <span style="float: left; width: 100px;"><p style="font-size: 20px">疾病诊断</p></span>
            <span style="float: left; margin-top: 2px"><p style="font-size: 13px; padding-top: 5px" :class="this.currentPatient.currentDisease.diagnoseStatus === '已确诊' ? 'set_grey':''">{{this.currentPatient.currentDisease.diagnoseStatus}}</p></span>
            <span style="float: right; margin-right: 20px">
                <el-button-group>
                    <el-button size="small"  plain  @click="saveDiseaseDiagnose" :disabled="itemDisabled">暂存</el-button>
                    <el-button size="small" plain @click="setSubmittedMDiseaseDiagnose" :disabled="itemDisabled">确诊</el-button>
                </el-button-group>
            </span>
        </div>
        <div style="height: 20px; margin-left: 10px">
            <span style="float: left; width: 100px"><p style="font-size: 17px">确诊情况</p></span>
        </div>
        <!--
            ...
            <el-table
                ...
                <el-table-column type="expand">
                    <template slot-scope="props">
                        <div style="padding-top: 1px; padding-bottom: 1px; font-size: 12px; margin: 0px 0px 0px 0px"> 疾病名称: {{ props.row.diseaseName }}</div>
                        <div style="padding-top: 1px; padding-bottom: 1px;  font-size: 12px">疾病助记码: {{ props.row.memonicCode }}</div>
                        <div style="padding-top: 1px; padding-bottom: 1px;  font-size: 12px">ICD编码: {{ props.row.ICDCode }}</div>
                    </template>
                </el-table-column>
                <el-table-column
                        label="疾病名称"
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button
                                ...
                                @click="handleDeleteDisease(scope.$index, scope.row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        <div style="margin-left: 10px">
            ...
            <el-input
                    ...
                    v-model="diseaseSearch"> </el-input>
            <el-table
