    ...
    <div>
        <div style="width: 60%; height: 500px; float: left;
            ...
            <div style="height: 40px">
                <span style="float: left; width: 200px"><p style="font-size: 20px; margin-left: 100px">病历内容</p></span>
                <span style="float: left; margin-top: 2px"><p style="font-size: 13px; padding-top: 5px" :class="this.currentPatient.currentRecord.status === '已提交' ? 'set_grey':''">{{this.currentPatient.currentRecord.status}}</p></span>
                <span style="float: right; margin-right: 20px">
                    <el-button-group>
                        <el-button size="small"  plain :disabled="this.haveSubmittedMedRecord" @click="saveMedRecord">暂存</el-button>
                        <el-button size="small" plain :disabled="this.haveSubmittedMedRecord" @click="setSubmittedMedRecord">提交</el-button>
                    </el-button-group>
                </span>
            </div>
            <div style="width: 90%; margin-top: 5px">
                <div > </div>
                <el-form ref="form" :model="form" label-width="100px" label-position="right" :disabled="this.haveSubmittedMedRecord">
